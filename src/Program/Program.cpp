...
void nModel::Program::setInt(int number, const std::string &name)
{
    GLuint transformLoc = glGetUniformLocation(mProgram, name.c_str());
    glUniform1i(transformLoc, number);
}

void nModel::Program::setFloat(float number, const std::string &name)
{
    GLuint transformLoc = glGetUniformLocation(mProgram, name.c_str());
